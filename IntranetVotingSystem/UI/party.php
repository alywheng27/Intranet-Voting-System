    ...
    <div class="content">
      ...
      <div class="card">
            ...
            <div class="card-body table-responsive">
              <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#party">Add Party</button>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php include 'IntranetVotingSystem/UI/UIDynamics/Party/party.php'; ?>
                </tbody>
                <tfoot>
                <tr>
                  <th>Party</th>
...
<?php include 'IntranetVotingSystem/UI/UIDynamics/Party/modal.php'; ?>
